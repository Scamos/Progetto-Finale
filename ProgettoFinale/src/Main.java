...
class ResponsabileBarVenditore extends UtenteRegistrato {
    //Utilizzando l'ereditarietà, non è necessario riscrivere questi attributi
    //private String email;
    //private String password;
    ...
    //Getter per email
    //public String getEmailResponsabileBarVenditore() {
        //return email;
    //}

    //Getter per password
    //public String getPasswordResponsabileBarVenditore() {
        //return password;
    //}

    //Altri metodi e funzionalità specifici per il Responsabile di Bar o Venditore
}
...
class Organizzatore extends ResponsabileBarVenditore {
    ...
    //Altri metodi e funzionalità specifici per l'Organizzatore
}
